...
function AuthPanelContent({ mode: initialMode }: { mode: AuthMode }) {
  ...
  return (
    <main className="flex-1 min-h-0 overflow-y-auto bg-surface-dim bg-[radial-gradient(#a14000_1px,transparent_1px)] [background-size:24px_24px] px-4 py-10">
      <div className="mx-auto flex min-h-full max-w-5xl items-center justify-center">
        <section className="grid w-full max-w-4xl overflow-hidden border border-outline-variant bg-surface shadow-2xl md:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="p-6 sm:p-9">
            ...
            {/* Mode Switcher Tabs (Regular vs Admin) */}
            ...
            {/* Prompt for Admin Login on Signup page */}
            {isSignup && (
              <div className="mt-5 border border-primary/40 bg-primary/5 p-3.5 text-center">
                <p className="font-mono text-xs text-secondary">
                  ...
                  >
                    <span>for admin sign up click here</span>
