  ...
  return (
    ...
    >
        ...
        <nav className="h-full flex items-center shrink-0">
          ...
          {authReady && user?.role === 'admin' && (
            <Link
              href="/admin"
              className={`
                relative h-full px-2 flex items-center justify-center gap-1
                font-mono-label text-[10px] tracking-widest transition-colors
                ${
      ...
      <div
        ...
        "
      >
        <div className="flex items-center h-full min-w-0 flex-1 overflow-hidden">
          {authReady && (user ? (
            <>
            ...
            <>
              <Link href="/login?mode=admin" className="h-full flex items-center gap-1 border-r border-outline-variant px-2.5 font-mono-label text-[10px] font-bold tracking-widest text-primary transition-colors hover:bg-primary/10 shrink-0" title="Admin Portal Sign In">
                <span className="material-symbols-outlined text-[15px]">shield_person</span>ADMIN
              </Link>
              <Link href="/login" className="h-full flex items-center justify-center px-2.5 font-mono-label text-[10px] tracking-widest text-secondary transition-colors hover:bg-surface-container-high hover:text-primary shrink-0">SIGN IN</Link>
              <Link href="/signup" className="h-full flex items-center justify-center bg-primary px-2.5 font-mono-label text-[10px] font-bold tracking-widest text-on-primary transition-colors hover:bg-primary-container hover:text-on-primary-container shrink-0">REGISTER</Link>
            </>
          ))}
        </div>
